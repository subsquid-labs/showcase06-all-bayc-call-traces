module.exports = class Data1702925302131 {
    name = 'Data1702925302131'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "transaction_touching_bayc" ("id" character varying NOT NULL, "block" integer NOT NULL, "txn_hash" text NOT NULL, "from" text NOT NULL, "to" text, CONSTRAINT "PK_064702d6b4b2f483e26a668cdb4" PRIMARY KEY ("id"))`)
